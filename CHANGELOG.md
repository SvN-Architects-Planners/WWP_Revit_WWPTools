...
- Export to Excel (Classic): Batch Export now prompts for a file/folder path on any set that has no saved destination, instead of skipping it. Sets with a saved path continue to use it automatically.
