...
STANDARD_HEADER_PARAMETER_ALIASES = {
    ...
    "Salable": ["! P_STATS_Area/Room_NSA_YesNo", "P_STATS_Area/Room_NSA_YesNo"],
    "Selable": ["! P_STATS_Area/Room_NSA_YesNo", "P_STATS_Area/Room_NSA_YesNo"],
    "Saleable": ["! P_STATS_Area/Room_NSA_YesNo", "P_STATS_Area/Room_NSA_YesNo"],
